...
**BESS** represents an energy resource and its interface controls. Storage and photovoltaic models combine source-side energy or power limits with converter commands, so available active power, DC voltage, and reactive-power control must remain mutually consistent.
