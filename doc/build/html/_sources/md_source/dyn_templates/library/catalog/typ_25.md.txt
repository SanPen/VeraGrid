# yi less than or equal C

This is Basic Block Catalog type `25` (`yi less than or equal C`). It implements logical or event-driven signal behaviour.

<!-- veragrid-block-introduction:start -->
**yi less than or equal C** belongs to the hybrid/event layer of a dynamic model. It selects, stores, delays, or switches signals according to conditions, so its result depends on discrete mode or accepted simulation history in addition to the instantaneous continuous variables.
...
$$
0 = (yo - (proc_{select\_const\_0} \cdot 1 + (1 - proc_{select\_const\_0}) \cdot 0))
$$
