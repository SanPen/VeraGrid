...
This is Basic Block Catalog type `86` (`selfix_const`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo - (proc_{selfix\_const\_0} \cdot K_{true} + (1 - proc_{selfix\_const\_0}) \cdot K_{false}))
$$
