...
This is Basic Block Catalog type `15` (`Lookup array object (linear_noclipping)`). It evaluates tabulated or array-based data using the selected lookup formulation.
