# 1/s (parameter input) [signal: xrst/rst; param: y_max/y_min; 1 state]

This is Basic Block Catalog type `265` (`1/s (p`). It represents a continuous-time dynamic operation, including any declared internal states.

<!-- veragrid-block-introduction:start -->
**1/s (parameter input) [signal: xrst/rst; param: y_max/y_min; 1 state]** implements a feedback-control relation. Such blocks turn tracking error into an actuator command and may contain proportional, integral, filtering, or dynamic compensation terms. Their gains set closed-loop speed and damping rather than changing the underlying network physics directly.
...
| State | `1/s (p__x` | Internal dynamic state | model-dependent |
