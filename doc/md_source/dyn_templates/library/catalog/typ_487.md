# Square Wave Generator ip

This is Basic Block Catalog type `487` (`Square Wave Generator_ip`). It generates or evaluates a time-dependent waveform.

<!-- veragrid-block-introduction:start -->
**Square Wave Generator ip** belongs to an electromechanical machine or prime-mover model. It links electrical torque and flux with rotor speed, angle, mechanical power, or actuator dynamics, making it central to frequency, voltage, and rotor-angle stability studies.
...
$$
Square Wave Generator_{ip\_t0}(t_0) = glob_{time}
$$
