...
This is Basic Block Catalog type `488` (`Time`). It generates or evaluates a time-dependent waveform.
...
| --- | --- | --- | --- |
| Output | `t` | Output signal produced by the block | model-dependent |
