...
This is Basic Block Catalog type `510` (`Switch par 2->1 by par`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo - (proc_{selfix\_const\_0} \cdot K2 + (1 - proc_{selfix\_const\_0}) \cdot K1))
$$
