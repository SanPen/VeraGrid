...
This is Basic Block Catalog type `515` (`Switch sig 1->2 by par`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo1 - (proc_{selfix\_2} \cdot 0 + (1 - proc_{selfix\_2}) \cdot yi))
$$

$$
0 = (yo2 - (proc_{selfix\_3} \cdot yi + (1 - proc_{selfix\_3}) \cdot 0))
$$

$$
yo1(t_0) = (proc_{selfix\_0} \cdot 0 + (1 - proc_{selfix\_0}) \cdot yi)
$$

$$
yo2(t_0) = (proc_{selfix\_1} \cdot yi + (1 - proc_{selfix\_1}) \cdot 0)
$$
