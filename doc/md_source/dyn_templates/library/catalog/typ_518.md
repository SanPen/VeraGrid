...
This is Basic Block Catalog type `518` (`Switch sig 2->1 by par (bool)`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo - (proc_{selfix\_1} \cdot 0 + (1 - proc_{selfix\_1}) \cdot (proc_{selfix\_0} \cdot yi2 + (1 - proc_{selfix\_0}) \cdot yi1)))
$$
