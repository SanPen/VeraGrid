...
This is Basic Block Catalog type `519` (`Switch sig 2->1 by par`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo - (proc_{selfix\_0} \cdot yi2 + (1 - proc_{selfix\_0}) \cdot yi1))
$$
