...
This is Basic Block Catalog type `528` (`Switch sw not equal C 2s->1s`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo - (proc_{select\_0} \cdot yi2 + (1 - proc_{select\_0}) \cdot yi1))
$$
