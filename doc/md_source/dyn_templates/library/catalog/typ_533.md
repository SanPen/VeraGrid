...
This is Basic Block Catalog type `533` (`Clarke transform (power invariant)`). It converts signals between the coordinate systems or units identified by the block name.
...
$$
0 = (alpha - (\sqrt{\frac{2}{3}} \cdot a - \frac{1}{\sqrt{6}} \cdot b - \frac{1}{\sqrt{6}} \cdot c))
$$

$$
0 = (beta - (\frac{1}{\sqrt{2}} \cdot b - \sqrt{2} \cdot c))
$$

$$
0 = (gamma - (\frac{1}{\sqrt{3}} \cdot a + \frac{1}{\sqrt{3}} \cdot b + \frac{1}{\sqrt{3}} \cdot c))
$$
