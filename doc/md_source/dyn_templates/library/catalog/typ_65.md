...
This is Basic Block Catalog type `65` (`aflipflop`). It implements logical or event-driven signal behaviour.
...
| Input | `set` | Input signal consumed by the block | model-dependent |
