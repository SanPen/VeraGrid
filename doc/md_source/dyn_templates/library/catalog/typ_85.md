...
This is Basic Block Catalog type `85` (`selfix`). It implements logical or event-driven signal behaviour.
...
$$
0 = (yo - (proc_{selfix\_0} \cdot y_{true} + (1 - proc_{selfix\_0}) \cdot y_{false}))
$$
