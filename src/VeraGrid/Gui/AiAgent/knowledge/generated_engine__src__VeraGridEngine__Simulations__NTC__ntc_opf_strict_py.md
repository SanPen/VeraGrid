# VeraGridEngine Module: src/VeraGridEngine/Simulations/NTC/ntc_opf_strict.py

- Original source path: `src/VeraGridEngine/Simulations/NTC/ntc_opf_strict.py`
...
- `get_values(self, Sbase, model)`
  Summary: Return an instance of this class where the arrays content are not LP vars but their value
- `add_contingency_flow(self, t, m, c, flow_var)`
...
## Function: add_linear_branches_formulation(t_idx, Sbase, branch_data_t, active_branch_data_t, branch_vars, bus_vars, prob, monitor_only_sensitive_branches, monitor_only_ntc_load_rule_branches, alpha, alpha_threshold, structural_ntc, ntc_load_rule, inf)

Formulate the branches

## Function: add_linear_branches_contingencies_formulation(t_idx, Sbase, branch_data_t, branch_vars, bus_vars, hvdc_vars, vsc_vars, prob, linear_multi_contingencies, monitor_only_ntc_load_rule_branches, monitor_only_sensitive_branches, structural_ntc, ntc_load_rule, alpha_threshold, alpha_n1_abs)

Formulate the branches

## Function: add_linear_hvdc_formulation(t_idx, Sbase, hvdc_data_t, hvdc_vars, vars_bus, prob, saturate)
...
## Function: run_linear_ntc_opf_strict(grid, t, solver_type, zonal_grouping, skip_generation_limits, consider_contingencies, contingency_groups_used, alpha_threshold, lodf_threshold, bus_a1_idx, bus_a2_idx, transfer_method, monitor_only_sensitive_branches, monitor_only_ntc_load_rule_branches, ntc_load_rule, logger, progress_text, progress_func, verbose, robust)
