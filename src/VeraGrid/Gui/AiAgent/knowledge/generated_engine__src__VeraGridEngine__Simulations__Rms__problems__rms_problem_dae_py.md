# VeraGridEngine Module: src/VeraGridEngine/Simulations/Rms/problems/rms_problem_dae.py

- Original source path: `src/VeraGridEngine/Simulations/Rms/problems/rms_problem_dae.py`
...
- Representative imports: typing, time, numpy, pandas, scipy.sparse, VeraGridEngine, VeraGridEngine.Devices, VeraGridEngine.Simulations.driver_template, VeraGridEngine.Utils.Symbolic.jit_compiler, VeraGridEngine.Utils.Symbolic.symbolic, VeraGridEngine.Utils.Symbolic.compiled_functions, VeraGridEngine.Utils.Symbolic.block, VeraGridEngine.Utils.Symbolic.symbolic_io, VeraGridEngine.enumerations, VeraGridEngine.basic_structures, VeraGridEngine.Simulations.PowerFlow.power_flow_driver
...
- `set_events_group(self, rms_events_group)`
  Summary: add events modifying values of event_parameters equations
