# VeraGridEngine Module: src/VeraGridEngine/Templates/Rms/load_phasor_current_rms_template.py

- Original source path: `src/VeraGridEngine/Templates/Rms/load_phasor_current_rms_template.py`
...
## Function: get_load_phasor_current_rms_template(vfactory, name, Ir0, Ii0)
