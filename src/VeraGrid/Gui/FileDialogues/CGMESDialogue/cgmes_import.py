...
class CgmesImportDialogue(QtWidgets.QDialog):
    ...
    def __init__(self, app: IoMain, options: FileOpenOptions):
        ...
        self.ui.cgmesVersionComboBox.addItems([value.value for value in self._version_values])
        self.ui.cgmesTopologyComboBox.addItems([value.value for value in self._topology_values])
        self.ui.cgmesRecoveryComboBox.addItems([value.value for value in self._recovery_values])
    ...
    def _set_initial_values(self) -> None:
        ...
        self.ui.cgmesVersionComboBox.setCurrentText(version.value)
        self.ui.cgmesTopologyComboBox.setCurrentText(self.options.cgmes_topology_mode.value)
        self.ui.cgmesRecoveryComboBox.setCurrentText(self.options.cgmes_recovery_mode.value)
    ...
    def do_it(self) -> None:
        ...
        :return: None.
        """
        self.options.cgmes_version = CGMESVersions(self.ui.cgmesVersionComboBox.currentText())
        self.options.cgmes_topology_mode = CgmesTopologyMode(self.ui.cgmesTopologyComboBox.currentText())
        self.options.cgmes_recovery_mode = CgmesRecoveryMode(self.ui.cgmesRecoveryComboBox.currentText())
