...
class EmtEventsGroup(EditableDevice):
    """
    EMT events group.
    """
    __slots__ = (
    ...
    LOCAL_PROPERTY_DECLARATIONS: Tuple[GCProp, ...] = (
        GCProp(
            ...
            units='',
            tpe=bool,
            definition='True if this EMT events group must be simulated.',
        ),
    )
    ...
    def __init__(self,
                 ...
                 comment: str = "") -> None:
        """
        Build an EMT events group.

        :param idtag: Unique identifier.
        :param active: True if this EMT events group must be simulated.
        ...
        EditableDevice.__init__(self,
                                ...
                                idtag=idtag,
                                code='',
                                device_type=DeviceType.EmtEventsGroupDevice,
                                comment=comment)
