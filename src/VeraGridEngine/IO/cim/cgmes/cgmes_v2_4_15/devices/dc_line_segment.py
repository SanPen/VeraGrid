...
class DCLineSegment(DCConductingEquipment):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='capacitance', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.F, description='''Capacitive part of reactance (imaginary part of impedance), at rated frequency.''', profiles=[CgmesProfileType.EQ]),
		...
		CgmesProperty(property_name='resistance', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.ohm, description='''Resistance (real part of impedance).''', profiles=[CgmesProfileType.EQ]),
		CgmesProperty(property_name='length', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. Never negative.''', profiles=[CgmesProfileType.EQ]),
		CgmesProperty(property_name='PerLengthParameter', class_type='PerLengthDCLineParameter', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Set of per-length parameters for this line segment.''', profiles=[CgmesProfileType.EQ]),
	)
