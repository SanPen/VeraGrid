...
class MutualCoupling(IdentifiedObject):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		...
		CgmesProperty(property_name='distance11', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. Never negative.''', profiles=[]),
		CgmesProperty(property_name='distance12', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. Never negative.''', profiles=[]),
		CgmesProperty(property_name='distance21', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. Never negative.''', profiles=[]),
		CgmesProperty(property_name='distance22', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. Never negative.''', profiles=[]),
