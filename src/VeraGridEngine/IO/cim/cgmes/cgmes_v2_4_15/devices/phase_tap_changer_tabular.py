...
class PhaseTapChangerTabular(PhaseTapChanger):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='PhaseTapChangerTable', class_type='PhaseTapChangerTable', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The phase tap changer table for this phase tap changer.''', profiles=[CgmesProfileType.EQ]),
	)
