...
from VeraGridEngine.IO.cim.cgmes.cgmes_enums import UnitSymbol, WindingConnection, CgmesProfileType
...
class PowerTransformerEnd(TransformerEnd):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='PowerTransformer', class_type='PowerTransformer', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The ends of this power transformer.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
