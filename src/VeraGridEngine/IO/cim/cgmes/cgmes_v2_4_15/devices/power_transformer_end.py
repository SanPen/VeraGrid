...
from VeraGridEngine.IO.cim.cgmes.cgmes_enums import UnitSymbol, WindingConnection
...
class PowerTransformerEnd(TransformerEnd):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='PowerTransformer', class_type='PowerTransformer', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The ends of this power transformer.''', profiles=[]),
		...
		CgmesProperty(property_name='connectionKind', class_type=WindingConnection, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Kind of connection.''', profiles=[]),
	...
	__slots__ = ('PowerTransformer', 'b', 'connectionKind', 'b0', 'phaseAngleClock', 'ratedS', 'g', 'ratedU', 'g0', 'r', 'r0', 'x', 'x0')
