...
from VeraGridEngine.IO.cim.cgmes.cgmes_enums import RegulatingControlModeKind, UnitMultiplier, CgmesProfileType
...
class RegulatingControl(PowerSystemResource):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='Terminal', class_type='Terminal', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The controls regulating this terminal.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
		...
		CgmesProperty(property_name='targetDeadband', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''A floating point number. The range is unspecified and not limited.''', profiles=[CgmesProfileType.SSH], default_value=0.0),
		CgmesProperty(property_name='targetValue', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''A floating point number. The range is unspecified and not limited.''', mandatory=True, profiles=[CgmesProfileType.SSH]),
	...
	__slots__ = ('Terminal', 'RegulatingCondEq', 'mode', 'discrete', 'enabled', 'targetDeadband', 'targetValue', 'targetValueUnitMultiplier')
