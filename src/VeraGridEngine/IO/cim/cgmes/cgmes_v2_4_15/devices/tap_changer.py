...
The attribute shall be greater than lowStep.''', profiles=[], default_value=0),
		CgmesProperty(property_name='lowStep', class_type=int, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Lowest possible tap step position, retard from neutral''', profiles=[], default_value=0),
		CgmesProperty(property_name='ltcFlag', class_type=bool, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Specifies whether or not a TapChanger has load tap changing capabilities.''', profiles=[], default_value=False),
...
The attribute shall be equal or greater than lowStep and equal or less than highStep.''', profiles=[], default_value=0),
...
The attribute shall be equal or greater than lowStep and equal or less than highStep.''', profiles=[], default_value=0),
		...
		CgmesProperty(property_name='step', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''A floating point number. The range is unspecified and not limited.''', profiles=[], default_value=0.0),
	)
