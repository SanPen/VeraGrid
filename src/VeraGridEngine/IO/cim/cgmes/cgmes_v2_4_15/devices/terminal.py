...
class Terminal(ACDCTerminal):
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        ...
        CgmesProperty(property_name='ConnectivityNode', class_type='ConnectivityNode', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Terminals interconnected with zero impedance at a this connectivity node. ''', profiles=[]),
...
If the attribute is missing three phases (ABC or ABCN) shall be assumed.''', profiles=[]),
