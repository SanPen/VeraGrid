...
class ACDCConverterDCTerminal(DCBaseTerminal):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='DCConductingEquipment', class_type='ACDCConverter', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''A DC converter terminal belong to an DC converter.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
...
- For a bi-pole or symmetric monopole with three converter terminals use DCPolarityKind �positive�, �middle� and �negative�.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
