...
class AuxiliaryEquipment(Equipment):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='Terminal', class_type='Terminal', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The Terminal at the equipment where the AuxiliaryEquipment is attached.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
	__slots__ = ('Terminal',)
