...
class Clamp(ConductingEquipment):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='ACLineSegment', class_type='ACLineSegment', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The line segment to which the clamp is connected.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
