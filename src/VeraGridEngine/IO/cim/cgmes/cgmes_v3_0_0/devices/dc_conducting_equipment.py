...
class DCConductingEquipment(Equipment):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		...
		CgmesProperty(property_name='DCTerminals', class_type='DCTerminal', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''A DC conducting equipment has DC terminals.''', profiles=[CgmesProfileType.EQ]),
	)
