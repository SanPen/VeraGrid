...
class DCTerminal(DCBaseTerminal):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='DCConductingEquipment', class_type='DCConductingEquipment', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''An DC  terminal belong to a DC conducting equipment.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
