...
class ExternalNetworkInjection(RegulatingCondEq):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='governorSCD', class_type=float, multiplier=UnitMultiplier.M, unit=UnitSymbol.WPers, description='''Active power variation with frequency.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
		...
		CgmesProperty(property_name='ikSecond', class_type=bool, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Indicates whether initial symmetrical short-circuit current and power have been calculated according to IEC (Ik").  Used only if short circuit calculations are done according to superposition method.''', profiles=[CgmesProfileType.SC]),
		...
		CgmesProperty(property_name='maxR0ToX0Ratio', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Maximum ratio of zero sequence resistance of Network Feeder to its zero sequence reactance (R(0)/X(0) max). Used for short circuit data exchange according to IEC 60909.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		...
		CgmesProperty(property_name='maxZ0ToZ1Ratio', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Maximum ratio of zero sequence impedance to its positive sequence impedance (Z(0)/Z(1) max). Used for short circuit data exchange according to IEC 60909.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		...
		CgmesProperty(property_name='minZ0ToZ1Ratio', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Minimum ratio of zero sequence impedance to its positive sequence impedance (Z(0)/Z(1) min). Used for short circuit data exchange according to IEC 60909.''', mandatory=True, profiles=[CgmesProfileType.SC]),
