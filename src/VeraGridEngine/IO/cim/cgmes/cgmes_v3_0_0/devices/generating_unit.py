...
from VeraGridEngine.IO.cim.cgmes.cgmes_enums import UnitSymbol, GeneratorControlSource
...
class GeneratingUnit(Equipment):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		...
		CgmesProperty(property_name='genControlSource', class_type=GeneratorControlSource, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The source of controls for a generating unit.  Defines the control status of the generating unit.''', profiles=[]),
		...
		CgmesProperty(property_name='longPF', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Generating unit long term economic participation factor.''', profiles=[]),
		...
		CgmesProperty(property_name='shortPF', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Generating unit short term economic participation factor.''', profiles=[]),
		CgmesProperty(property_name='startupCost', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Amount of money.''', profiles=[]),
		CgmesProperty(property_name='variableCost', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Amount of money.''', profiles=[]),
		CgmesProperty(property_name='startupTime', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.s, description='''Time, in seconds.''', profiles=[]),
		...
		CgmesProperty(property_name='normalPF', class_type=float, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Generating unit economic participation factor.  The sum of the participation factors across generating units does not have to sum to one.  It is used for representing distributed slack participation factor. The attribute shall be a positive value or zero.''', profiles=[]),
	)
