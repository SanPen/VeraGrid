...
class LoadArea(EnergyArea):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='SubLoadAreas', class_type='SubLoadArea', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The SubLoadAreas in the LoadArea.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
