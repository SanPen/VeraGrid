...
class LoadGroup(IdentifiedObject):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='SubLoadArea', class_type='SubLoadArea', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The SubLoadArea where the Loadgroup belongs.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
