...
When the measurementType is set to "Specialization", the type of Measurement is defined in more detail by the specialized class which inherits from Measurement.''', profiles=[]),
...
If the attribute is missing three phases (ABC) shall be assumed.''', profiles=[]),
		...
		CgmesProperty(property_name='PowerSystemResource', class_type='PowerSystemResource', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The power system resource that contains the measurement.''', profiles=[]),
	)
