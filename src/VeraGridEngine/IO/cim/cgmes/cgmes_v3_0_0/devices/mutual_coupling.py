...
class MutualCoupling(IdentifiedObject):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		...
		CgmesProperty(property_name='distance11', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. It shall be a positive value or zero.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		CgmesProperty(property_name='distance12', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. It shall be a positive value or zero.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		CgmesProperty(property_name='distance21', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. It shall be a positive value or zero.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		CgmesProperty(property_name='distance22', class_type=float, multiplier=UnitMultiplier.k, unit=UnitSymbol.m, description='''Unit of length. It shall be a positive value or zero.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		...
		CgmesProperty(property_name='Second_Terminal', class_type='Terminal', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The starting terminal for the calculation of distances along the second branch of the mutual coupling.''', mandatory=True, profiles=[CgmesProfileType.SC]),
		CgmesProperty(property_name='First_Terminal', class_type='Terminal', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The starting terminal for the calculation of distances along the first branch of the mutual coupling.  Normally MutualCoupling would only be used for terminals of AC line segments.  The first and second terminals of a mutual coupling should point to different AC line segments.''', mandatory=True, profiles=[CgmesProfileType.SC]),
	)
	__slots__ = ('b0ch', 'distance11', 'distance12', 'distance21', 'distance22', 'g0ch', 'r0', 'x0', 'Second_Terminal', 'First_Terminal')
