...
class OperationalLimit(IdentifiedObject):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='OperationalLimitSet', class_type='OperationalLimitSet', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The limit set to which the limit values belong.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
		CgmesProperty(property_name='OperationalLimitType', class_type='OperationalLimitType', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The limit type associated with this limit.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
