...
class OperationalLimitSet(IdentifiedObject):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='Terminal', class_type='ACDCTerminal', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The terminal where the operational limit set apply.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
		...
		CgmesProperty(property_name='OperationalLimitValue', class_type='OperationalLimit', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''Values of equipment limits.''', profiles=[CgmesProfileType.EQ]),
	)
