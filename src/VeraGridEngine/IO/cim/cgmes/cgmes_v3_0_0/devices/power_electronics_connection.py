...
class PowerElectronicsConnection(RegulatingCondEq):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		...
		CgmesProperty(property_name='PowerElectronicsUnit', class_type='PowerElectronicsUnit', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''An AC network connection may have several power electronics units connecting through it.''', profiles=[CgmesProfileType.EQ]),
