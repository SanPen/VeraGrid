...
class TapChangerControl(RegulatingControl):
	LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
		CgmesProperty(property_name='TapChanger', class_type='TapChanger', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='''The tap changers that participates in this regulating tap control scheme.''', mandatory=True, profiles=[CgmesProfileType.EQ]),
	)
