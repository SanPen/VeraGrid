...
class ControlFunctionBlockAction(SetPointAction):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ControlFunctionBlock', class_type='ControlFunctionBlock', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.RA]),
    )
    __slots__ = ('ControlFunctionBlock')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.ControlFunctionBlock: object | None = None
