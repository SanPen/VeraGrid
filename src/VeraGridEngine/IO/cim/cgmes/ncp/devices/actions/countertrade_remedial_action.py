...
class CountertradeRemedialAction(PowerRemedialAction):
    ...
    def __init__(self, rdfid: str = '', tpe: str = 'CountertradeRemedialAction'):
        PowerRemedialAction.__init__(self, rdfid, tpe)

        self.maxEconomicPMargin: float | None = None
        self.minEconomicPMargin: float | None = None
