...
class ExternalNetworkInjectionAction(SetPointAction):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ExternalNetworkInjection', class_type='ExternalNetworkInjection', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.RA]),
    )
    __slots__ = ('ExternalNetworkInjection')
