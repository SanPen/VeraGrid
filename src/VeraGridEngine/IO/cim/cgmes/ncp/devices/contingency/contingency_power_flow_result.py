...
class ContingencyPowerFlowResult(PowerFlowResult):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='Contingency', class_type='Contingency', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', mandatory=True, profiles=[CgmesProfileType.SAR]),
    )
    __slots__ = ('Contingency')

    def __init__(self, rdfid: str = '', tpe: str = 'ContingencyPowerFlowResult'):
        PowerFlowResult.__init__(self, rdfid, tpe)
