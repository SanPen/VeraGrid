...
class MeasurementCalculator(IdentifiedObject):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='MeasurementCalculatorInput', class_type='MeasurementCalculatorInput', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', mandatory=True, profiles=[CgmesProfileType.RA]),
        CgmesProperty(property_name='PinMeasurement', class_type='PinMeasurement', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.RA]),
