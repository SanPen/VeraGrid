...
class ACPointOfCommonCoupling(PointOfCommonCoupling):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ConnectivityNode', class_type='ConnectivityNode', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', mandatory=True, profiles=[CgmesProfileType.ER]),
    ...
    __slots__ = ('ConnectivityNode', 'DCConverterUnit')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        :return: Nothing.
        """
        PointOfCommonCoupling.__init__(self, rdfid, tpe)

        self.ConnectivityNode: object | None = None
