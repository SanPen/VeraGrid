...
class BipolarDCSystem(DCSystem):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        ...
        CgmesProperty(property_name='isRigid', class_type=str, multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', mandatory=True, profiles=[CgmesProfileType.ER]),
    )
    __slots__ = ('DCBiPole', 'isRigid')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        :return: Nothing.
        """
        DCSystem.__init__(self, rdfid, tpe)

        self.DCBiPole: object | None = None
        self.isRigid: str | None = None
