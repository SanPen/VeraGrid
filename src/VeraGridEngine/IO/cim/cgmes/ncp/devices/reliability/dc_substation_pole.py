...
class DCSubstationPole(DCEquipmentContainer):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        ...
        CgmesProperty(property_name='DirectCurrentSubstationPoleController', class_type='DirectCurrentSubstationPoleController', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.ER]),
    )
