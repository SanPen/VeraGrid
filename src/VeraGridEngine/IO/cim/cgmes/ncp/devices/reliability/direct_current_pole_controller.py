...
class DirectCurrentPoleController(DirectCurrentEquipmentController):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ACDCConverterController', class_type='ACDCConverterController', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.ER]),
