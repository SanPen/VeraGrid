...
class DirectCurrentPoleController(DirectCurrentEquipmentController):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ACDCConverterController', class_type='ACDCConverterController', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.ER]),
    ...
    __slots__ = ('ACDCConverterController', 'DCPole', 'DirectCurrentBipoleController', 'DirectCurrentMasterController')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.ACDCConverterController: object | None = None
        self.DCPole: object | None = None
        self.DirectCurrentBipoleController: object | None = None
