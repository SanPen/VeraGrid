...
class DirectCurrentSubstationBipoleController(DirectCurrentSubstationController):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='DCSubstationBipole', class_type='DCSubstationBipole', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.ER]),
    )
    __slots__ = ('DCSubstationBipole')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        :return: Nothing.
        """
        DirectCurrentSubstationController.__init__(self, rdfid, tpe)
