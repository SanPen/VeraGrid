...
class DirectCurrentSubstationBipoleController(DirectCurrentSubstationController):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='DCSubstationBipole', class_type='DCSubstationBipole', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', mandatory=True, profiles=[CgmesProfileType.ER]),
    )
