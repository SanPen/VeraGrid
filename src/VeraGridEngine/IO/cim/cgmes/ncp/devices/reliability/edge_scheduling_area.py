...
class EdgeSchedulingArea(SubSchedulingArea):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='Installation', class_type='Installation', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.ER]),
    )
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        :return: Nothing.
        """
        SubSchedulingArea.__init__(self, rdfid, tpe)

        self.Installation: object | None = None
