...
class EnergyAlignmentCoordinator(SystemOperationCoordinator):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='EnergyCoordinationRegion', class_type='EnergyCoordinationRegion', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.ER]),
    )
    __slots__ = ('EnergyCoordinationRegion')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.EnergyCoordinationRegion: object | None = None
