...
class EquivalentPowerElectronicsUnit(PowerElectronicsUnit):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='EquivalentPowerPlant', class_type='EquivalentPowerPlant', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.ER]),
    )
