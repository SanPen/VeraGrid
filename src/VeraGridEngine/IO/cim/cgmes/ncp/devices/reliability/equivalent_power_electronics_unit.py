...
class EquivalentPowerElectronicsUnit(PowerElectronicsUnit):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='EquivalentPowerPlant', class_type='EquivalentPowerPlant', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.ER]),
    )
    __slots__ = ('EquivalentPowerPlant')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.EquivalentPowerPlant: object | None = None
