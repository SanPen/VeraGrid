...
class MobileElectricalUnit(BatteryUnit):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ElectricalChargingUnit', class_type='ElectricalChargingUnit', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.ER]),
    )
    __slots__ = ('ElectricalChargingUnit')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        :return: Nothing.
        """
        BatteryUnit.__init__(self, rdfid, tpe)

        self.ElectricalChargingUnit: object | None = None
