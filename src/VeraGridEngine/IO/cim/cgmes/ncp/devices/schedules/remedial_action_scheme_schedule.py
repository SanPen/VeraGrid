...
class RemedialActionSchemeSchedule(BaseIrregularTimeSeries):
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.ArmedRemedialAction: object | None = None
        self.RemedialActionSchemeTimePoint: object | None = None
