...
class ReservoirTimePoint(IdentifiedObject):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='ReservoirSchedule', class_type='ReservoirSchedule', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', profiles=[CgmesProfileType.NC, CgmesProfileType.SHS, CgmesProfileType.SIS]),
    ...
    __slots__ = ('ReservoirSchedule', 'atTime', 'energyStorage')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.ReservoirSchedule: object | None = None
