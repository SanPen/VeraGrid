...
class StaticVarCompensatorTimePoint(IdentifiedObject):
    ...
    LOCAL_CGMES_PROPERTIES: tuple[CgmesProperty, ...] = (
        CgmesProperty(property_name='StaticVarCompensatorSchedule', class_type='StaticVarCompensatorSchedule', multiplier=UnitMultiplier.none, unit=UnitSymbol.none, description='', mandatory=True, profiles=[CgmesProfileType.SHS]),
    ...
    __slots__ = ('StaticVarCompensatorSchedule', 'atTime', 'q')
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.StaticVarCompensatorSchedule: object | None = None
