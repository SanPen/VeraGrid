...
class TapChangerControlRegularSchedule(RegulatingControlRegularSchedule):
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        :return: Nothing.
        """
        RegulatingControlRegularSchedule.__init__(self, rdfid, tpe)
