...
class SensitivityFactor(IdentifiedObject):
    ...
    def __init__(self, rdfid: str = '', tpe: str = '" + class_info.name + "') -> None:
        ...
        self.ControllableQuantity: object | None = None
        self.ObservableQuantity: object | None = None
        self.SensitivityMatrix: object | None = None
