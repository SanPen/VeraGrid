...
"""Run the RMS Model Exchange FMU device example."""
...
from VeraGridEngine.IO.fmu.importer.examples.common import get_example_output_dir, run_rms_me_example


def main() -> int:
    """Execute the RMS ME example and print the report path.

    :return: Process exit code.
    """

    report_path = run_rms_me_example(get_example_output_dir())
    print(report_path)
    return 0
