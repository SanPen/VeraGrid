...
class IidmArea(IidmObject):
    def __init__(self, _id: str,
                 name: str = "",
                 area_type: str = "",
                 interchange_target: float = 0.0):
        """

        :param _id:
        :param name:
        :param area_type:
        :param interchange_target:
        """
        super().__init__("Area")
        self.id = _id
        self.name = name
        ...
        self.register_property("interchange_target", float,
                               description="The optional target interchange of this area in MW, "
                                           "using load sign convention (negative is export, positive is import)")
