...
WINDING2_FIELDS = [
    ...
    "COD2", "CONT2", "RMA2", "RMI2", "VMA2", "VMI2", "NTP2", "TAB2", "CR2", "CX2",
]

WINDING3_FIELDS = [
    "WINDV3", "NOMV3", "ANG3", "RATA3", "RATB3", "RATC3",
    "COD3", "CONT3", "RMA3", "RMI3", "VMA3", "VMI3", "NTP3", "TAB3", "CR3", "CX3",
]


class RawTransformerV30(RawTransformerV29):
        ...
        if len(data[3]) == 2:
            ...
            (self.WINDV2, self.NOMV2, self.ANG2, self.RATA2, self.RATB2, self.RATC2, self.COD2, self.CONT2,
             ...
             self.RMA3, self.RMI3, self.VMA3, self.VMI3, self.NTP3, self.TAB3, self.CR3, self.CX3) = (
                self.extend_or_curtail(data[3], 32)
            )
