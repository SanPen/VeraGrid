...
class RawTransformerV33(RawTransformerV32):
    ...
    def parse(self, data, version, logger: Logger):
        ...
        (self.I, self.J, self.K, self.CKT, self.CW, self.CZ, self.CM, self.MAG1, self.MAG2, self.NMETR,
         ...
         self.VECGRP) = self.extend_or_curtail(data[0], 21)

        if len(data) == 4:
            self.windings = 2
            self.R1_2, self.X1_2, self.SBASE1_2 = self.extend_or_curtail(data[1], 3)
            (self.WINDV1, self.NOMV1, self.ANG1, self.RATA1, self.RATB1, self.RATC1,
             self.COD1, self.CONT1, self.RMA1, self.RMI1, self.VMA1, self.VMI1, self.NTP1,
             self.TAB1, self.CR1, self.CX1, self.CNXA1) = self.extend_or_curtail(data[2], 17)
            ...
            (self.WINDV1, self.NOMV1, self.ANG1, self.RATA1, self.RATB1, self.RATC1, self.COD1, self.CONT1,
             self.RMA1, self.RMI1, self.VMA1, self.VMI1, self.NTP1, self.TAB1, self.CR1, self.CX1,
             self.CNXA1) = self.extend_or_curtail(data[2], 17)
            (self.WINDV2, self.NOMV2, self.ANG2, self.RATA2, self.RATB2, self.RATC2, self.COD2, self.CONT2,
             ...
             self.CNXA2) = self.extend_or_curtail(data[3], 17)
            (self.WINDV3, self.NOMV3, self.ANG3, self.RATA3, self.RATB3, self.RATC3, self.COD3, self.CONT3,
             self.RMA3, self.RMI3, self.VMA3, self.VMI3, self.NTP3, self.TAB3, self.CR3, self.CX3,
             self.CNXA3) = self.extend_or_curtail(data[4], 17)
