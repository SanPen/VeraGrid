...
class OptimalPowerFlowResults(ResultsTemplate):
    ...
    LOCAL_RESULTS_DECLARATIONS = (
        ...
        ResultsProperty(name='fluid_node_names', tpe=StrVec, old_names=list()),
        ResultsProperty(name='fluid_path_names', tpe=StrVec, old_names=list()),
        ResultsProperty(name='fluid_inj_names', tpe=StrVec, old_names=list()),
        ...
        ResultsProperty(name='bus_shadow_prices', tpe=Vec, old_names=list()),
        ResultsProperty(name='load_power', tpe=Vec, old_names=list()),
        ResultsProperty(name='load_shedding', tpe=Vec, old_names=list()),
        ResultsProperty(name='load_shedding_cost', tpe=Vec, old_names=list()),
        ResultsProperty(name='Sf', tpe=CxVec, old_names=list()),
        ResultsProperty(name='St', tpe=CxVec, old_names=list()),
        ResultsProperty(name='overloads', tpe=Vec, old_names=list()),
        ResultsProperty(name='overloads_cost', tpe=Vec, old_names=list()),
        ResultsProperty(name='loading', tpe=Vec, old_names=list()),
        ResultsProperty(name='losses', tpe=Vec, old_names=list()),
        ...
        ResultsProperty(name='vsc_Pf', tpe=Vec, old_names=list()),
        ResultsProperty(name='vsc_loading', tpe=Vec, old_names=list()),
        ResultsProperty(name='vsc_losses', tpe=Vec, old_names=list()),
        ResultsProperty(name='generator_power', tpe=Vec, old_names=list()),
        ResultsProperty(name='generator_reactive_power', tpe=Vec, old_names=list()),
        ResultsProperty(name='generator_shedding', tpe=Vec, old_names=list()),
        ResultsProperty(name='battery_power', tpe=Vec, old_names=list()),
        ResultsProperty(name='shunt_like_reactive_power', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_node_p2x_flow', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_node_current_level', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_node_spillage', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_node_flow_in', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_node_flow_out', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_path_flow', tpe=Vec, old_names=list()),
        ResultsProperty(name='fluid_injection_flow', tpe=Vec, old_names=list()),
        ResultsProperty(name='non_linear', tpe=bool, old_names=list()),
        ResultsProperty(name='converged', tpe=bool, old_names=list()),
        ResultsProperty(name='error', tpe=float, old_names=list()),
