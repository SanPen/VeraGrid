...
class OptimalPowerFlowTimeSeriesResults(ResultsTemplate):
    ...
    LOCAL_RESULTS_DECLARATIONS = (
        ...
        ResultsProperty(name='generator_names', tpe=StrVec, old_names=list()),
        ResultsProperty(name='battery_names', tpe=StrVec, old_names=list()),
        ResultsProperty(name='shunt_like_names', tpe=StrVec, old_names=list()),
        ...
        ResultsProperty(name='bus_shadow_prices', tpe=Mat, old_names=list()),
        ResultsProperty(name='load_power', tpe=Mat, old_names=list()),
        ResultsProperty(name='load_shedding', tpe=Mat, old_names=list()),
        ResultsProperty(name='load_shedding_cost', tpe=Mat, old_names=list()),
        ResultsProperty(name='Sf', tpe=CxMat, old_names=list()),
        ResultsProperty(name='St', tpe=CxMat, old_names=list()),
        ResultsProperty(name='loading', tpe=Mat, old_names=list()),
        ResultsProperty(name='losses', tpe=Mat, old_names=list()),
        ResultsProperty(name='tap_angle', tpe=Mat, old_names=list()),
        ResultsProperty(name='tap_module', tpe=Mat, old_names=list()),
        ResultsProperty(name='overloads', tpe=Mat, old_names=list()),
        ResultsProperty(name='overloads_cost', tpe=Mat, old_names=list()),
        ResultsProperty(name='rates', tpe=Vec, old_names=list()),
        ResultsProperty(name='contingency_rates', tpe=Vec, old_names=list()),
        ResultsProperty(name='contingency_flows_list', tpe=list, old_names=list()),
        ResultsProperty(name='contingency_indices_list', tpe=list, old_names=list()),
        ResultsProperty(name='contingency_flows_slacks_list', tpe=list, old_names=list()),
        ResultsProperty(name='hvdc_Pf', tpe=Mat, old_names=list()),
        ResultsProperty(name='hvdc_loading', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_node_current_level', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_node_flow_in', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_node_flow_out', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_node_p2x_flow', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_node_spillage', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_path_flow', tpe=Mat, old_names=list()),
        ResultsProperty(name='fluid_injection_flow', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_power', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_reactive_power', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_shedding', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_cost', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_producing', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_starting_up', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_shutting_down', tpe=Mat, old_names=list()),
        ResultsProperty(name='generator_invested', tpe=Mat, old_names=list()),
        ResultsProperty(name='shunt_like_reactive_power', tpe=Mat, old_names=list()),
        ResultsProperty(name='battery_power', tpe=Mat, old_names=list()),
        ResultsProperty(name='battery_energy', tpe=Mat, old_names=list()),
        ResultsProperty(name='system_fuel', tpe=Mat, old_names=list()),
        ResultsProperty(name='system_emissions', tpe=Mat, old_names=list()),
        ResultsProperty(name='system_energy_cost', tpe=Mat, old_names=list()),
        ResultsProperty(name='system_total_energy_cost', tpe=Mat, old_names=list()),
        ResultsProperty(name='power_by_technology', tpe=Mat, old_names=list()),
