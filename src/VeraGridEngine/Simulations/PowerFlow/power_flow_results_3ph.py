...
class PowerFlowResults3Ph(ResultsTemplate):
    ...
    LOCAL_RESULTS_DECLARATIONS = (
        ...
        ResultsProperty(name='Sbus_N', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Sbus_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Sbus_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Sbus_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='voltage_N', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='voltage_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='voltage_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='voltage_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Sf_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Sf_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Sf_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='St_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='St_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='St_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='If_N', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='If_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='If_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='If_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='It_N', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='It_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='It_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='It_C', tpe=CxVec, old_names=list(), expandable=False),
        ...
        ResultsProperty(name='Vbranch_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Vbranch_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='Vbranch_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='loading_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='loading_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='loading_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='losses_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='losses_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='losses_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='losses_hvdc', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='Pf_hvdc_A', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='Pf_hvdc_B', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='Pf_hvdc_C', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='Pt_hvdc_A', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='Pt_hvdc_B', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='Pt_hvdc_C', tpe=Vec, old_names=list(), expandable=False),
        ...
        ResultsProperty(name='St_vsc_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='St_vsc_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='St_vsc_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='If_vsc', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='It_vsc_A', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='It_vsc_B', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='It_vsc_C', tpe=CxVec, old_names=list(), expandable=False),
        ResultsProperty(name='loading_vsc', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='gen_q_A', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='gen_q_B', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='gen_q_C', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='battery_q_A', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='battery_q_B', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='battery_q_C', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='shunt_q_A', tpe=Vec, old_names=list(), expandable=False),
        ResultsProperty(name='shunt_q_B', tpe=Vec, old_names=list(), expandable=False),
