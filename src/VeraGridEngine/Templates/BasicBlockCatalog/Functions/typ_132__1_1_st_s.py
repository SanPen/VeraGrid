...
def build_typ_132__1_1_st_s_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return '1/(1+sT) (s__132'

def build_typ_132__1_1_st_s_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_132__1_1_st_s_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - ((y_min + ((v_1_1_sT_s_x - y_min) * sym.heaviside((v_1_1_sT_s_x - y_min)))) - ((v_1_1_sT_s_x - y_max) * sym.heaviside((v_1_1_sT_s_x - y_max))))))
