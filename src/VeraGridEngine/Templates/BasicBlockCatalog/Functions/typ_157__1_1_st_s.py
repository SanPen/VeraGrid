...
def build_typ_157__1_1_st_s_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return '1/(1+sT) (s__157'

def build_typ_157__1_1_st_s_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_157__1_1_st_s_default_template_name()
    else:
        template_name = name
    ...
    v_1_1_sT_s_x_init: Var = vf.add_var('1/(1+sT) (s_x_init_' + template_name)
    ...
    initial_equations[v_1_1_sT_s_x_init] = v_1_1_sT_s_x
    ...
    procedural_logic_entries.append(reset(v_1_1_sT_s_x, rst, v_1_1_sT_s_x_init))
