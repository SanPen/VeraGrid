...
def build_typ_172__multiply_1_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply 1__172'

def build_typ_172__multiply_1_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_172__multiply_1_default_template_name()
    else:
        template_name = name
