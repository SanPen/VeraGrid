...
"""
Standalone EMT template for the basic catalog block 'Multiply 1/SQRT2'.
...
def build_typ_176__multiply_1_sqrt2_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply 1/SQRT2__176'

def build_typ_176__multiply_1_sqrt2_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_176__multiply_1_sqrt2_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (yi / sym.sqrt(sym.Const(2.0)))))
