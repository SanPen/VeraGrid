...
"""
Standalone EMT template for the basic catalog block 'Multiply 1/SQRT3'.
...
def build_typ_177__multiply_1_sqrt3_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply 1/SQRT3__177'

def build_typ_177__multiply_1_sqrt3_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_177__multiply_1_sqrt3_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (yi / sym.sqrt(sym.Const(3.0)))))
