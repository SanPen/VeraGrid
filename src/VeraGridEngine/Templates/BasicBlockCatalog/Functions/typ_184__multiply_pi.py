...
"""
Standalone EMT template for the basic catalog block 'Multiply PI'.
...
def build_typ_184__multiply_pi_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply PI__184'

def build_typ_184__multiply_pi_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_184__multiply_pi_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (yi * sym.Const(3.141592653589793))))
