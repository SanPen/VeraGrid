...
"""
Standalone EMT template for the basic catalog block 'Multiply SQRT(2/3)'.
...
def build_typ_185__multiply_sqrt_2_3_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply SQRT(2/3)__185'

def build_typ_185__multiply_sqrt_2_3_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_185__multiply_sqrt_2_3_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (yi * sym.sqrt((sym.Const(2.0) / sym.Const(3.0))))))
