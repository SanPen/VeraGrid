...
"""
Standalone EMT template for the basic catalog block 'Multiply SQRT(3/2)'.
...
def build_typ_186__multiply_sqrt_3_2_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply SQRT(3/2)__186'

def build_typ_186__multiply_sqrt_3_2_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_186__multiply_sqrt_3_2_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (yi * sym.sqrt((sym.Const(3.0) / sym.Const(2.0))))))
