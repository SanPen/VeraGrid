...
"""
Standalone EMT template for the basic catalog block 'Multiply SQRT2'.
...
def build_typ_188__multiply_sqrt2_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply SQRT2__188'

def build_typ_188__multiply_sqrt2_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_188__multiply_sqrt2_default_template_name()
    else:
        template_name = name
