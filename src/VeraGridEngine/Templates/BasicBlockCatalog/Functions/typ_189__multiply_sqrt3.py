...
"""
Standalone EMT template for the basic catalog block 'Multiply SQRT3'.
...
def build_typ_189__multiply_sqrt3_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Multiply SQRT3__189'

def build_typ_189__multiply_sqrt3_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_189__multiply_sqrt3_default_template_name()
    else:
        template_name = name
