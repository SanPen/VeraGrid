...
def build_typ_285__1_st_default_template_name() -> str:
    """
...
def build_typ_285__1_st_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_285__1_st_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (((-sym.Const(999999999999.99)) + ((v_1_sT_x - (-sym.Const(999999999999.99))) * sym.heaviside((v_1_sT_x - (-sym.Const(999999999999.99)))))) - ((v_1_sT_x - v_1_sT_y_max) * sym.heaviside((v_1_sT_x - v_1_sT_y_max))))))
