...
def build_typ_311__limit_p_default_template_name() -> str:
    """
...
def build_typ_311__limit_p_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_311__limit_p_default_template_name()
    else:
        template_name = name
    ...
    Limit_p_proc_flipflop_4: Var = vf.add_var('Limit [p__proc_flipflop_4_' + template_name)
    Limit_p_proc_select_6: Var = vf.add_var('Limit [p__proc_select_6_' + template_name)
    ...
    Limit_p_proc_selfix_8: Var = vf.add_var('Limit [p__proc_selfix_8_' + template_name)
    ...
    algebraic_equations.append((Limit_p_yo_min - ((Limit_p_proc_selfix_5 * sym.Const(0.0)) + ((sym.Const(1.0) - Limit_p_proc_selfix_5) * Limit_p_proc_flipflop_4))))
    algebraic_equations.append((yo - ((Limit_p_proc_selfix_7 * ((yi * sym.heaviside((yi - Limit_p_y_min))) + (Limit_p_y_min * (sym.Const(1) - sym.heaviside((yi - Limit_p_y_min)))))) + ((sym.Const(1.0) - Limit_p_proc_selfix_7) * ((Limit_p_proc_select_6 * Limit_p_y_min) + ((sym.Const(1.0) - Limit_p_proc_select_6) * yi))))))
    ...
    mode_parameters[Limit_p_proc_flipflop_4] = vf.add_const(0.0, name='')
    mode_parameters[Limit_p_proc_selfix_5] = vf.add_const(0.0, name='')
    mode_parameters[Limit_p_proc_select_6] = vf.add_const(0.0, name='')
    mode_parameters[Limit_p_proc_selfix_7] = vf.add_const(0.0, name='')
    mode_parameters[Limit_p_proc_selfix_8] = vf.add_const(0.0, name='')
    mode_parameters[Limit_p_proc_selfix_9] = vf.add_const(0.0, name='')
    initial_equations: dict[Var, Expr | Const] = dict()
    initial_equations[Limit_p_setmin] = ((Limit_p_proc_selfix_8 * sym.heaviside(((Limit_p_y_min - yi) - sym.Const(1e-06)))) + ((sym.Const(1.0) - Limit_p_proc_selfix_8) * sym.heaviside(((Limit_p_y_min - (yi - Limit_p_eps)) - sym.Const(1e-06)))))
    initial_equations[Limit_p_rstmin] = ((Limit_p_proc_selfix_9 * sym.heaviside(((yi - Limit_p_y_min) - sym.Const(1e-06)))) + ((sym.Const(1.0) - Limit_p_proc_selfix_9) * sym.heaviside((((yi + Limit_p_eps) - Limit_p_y_min) - sym.Const(1e-06)))))
    ...
    procedural_logic_entries.append(flipflop(Limit_p_setmin, Limit_p_rstmin, output=Limit_p_proc_flipflop_4))
    ...
    procedural_logic_entries.append(sampled_value(output=Limit_p_proc_select_6, source=(sym.heaviside(((Limit_p_yo_min - 0.5) - 1e-06)) * sym.heaviside(((Limit_p_eps - 0.0) - 1e-06)))))
    ...
    procedural_logic_entries.append(selfix((sym.heaviside(((Limit_p_y_min - (yi - Limit_p_eps)) - 1e-06)) * sym.heaviside((((yi + Limit_p_eps) - Limit_p_y_min) - 1e-06))), output=Limit_p_proc_selfix_8))
    procedural_logic_entries.append(selfix((sym.heaviside(((Limit_p_y_min - (yi - Limit_p_eps)) - 1e-06)) * sym.heaviside((((yi + Limit_p_eps) - Limit_p_y_min) - 1e-06))), output=Limit_p_proc_selfix_9))
