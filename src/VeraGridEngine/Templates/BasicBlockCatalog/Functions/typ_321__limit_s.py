...
def build_typ_321__limit_s_default_template_name() -> str:
    """
...
def build_typ_321__limit_s_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_321__limit_s_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - ((y_min + ((yi - y_min) * sym.heaviside((yi - y_min)))) - ((yi - y_max) * sym.heaviside((yi - y_max))))))
