...
"""
Standalone EMT template for the basic catalog block 'EOR'.
...
def build_typ_337__eor_default_template_name() -> str:
    """
...
def build_typ_337__eor_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_337__eor_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - ((yi1 + yi2) - ((sym.Const(2.0) * yi1) * yi2))))
