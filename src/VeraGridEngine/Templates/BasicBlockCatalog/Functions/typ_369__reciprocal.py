...
"""
Standalone EMT template for the basic catalog block 'RECIPROCAL'.
...
def build_typ_369__reciprocal_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'RECIPROCAL__369'

def build_typ_369__reciprocal_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_369__reciprocal_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (sym.Const(1.0) / u)))
