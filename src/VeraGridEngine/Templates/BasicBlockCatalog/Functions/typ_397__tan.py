...
"""
Standalone EMT template for the basic catalog block 'TAN'.
...
def build_typ_397__tan_default_template_name() -> str:
    """
...
def build_typ_397__tan_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_397__tan_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - sym.tan(yi)))
