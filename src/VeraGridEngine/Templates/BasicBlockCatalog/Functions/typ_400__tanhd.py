...
"""
Standalone EMT template for the basic catalog block 'TANHD'.
...
def build_typ_400__tanhd_default_template_name() -> str:
    """
...
def build_typ_400__tanhd_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_400__tanhd_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - sym.tanh(((yi * sym.Const(3.141592653589793)) / sym.Const(180.0)))))
