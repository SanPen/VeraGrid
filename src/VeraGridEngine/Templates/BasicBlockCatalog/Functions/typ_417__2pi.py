...
"""
Standalone EMT template for the basic catalog block '2PI'.
...
def build_typ_417__2pi_default_template_name() -> str:
    """
...
def build_typ_417__2pi_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_417__2pi_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - sym.Const(6.283185307179586)))
