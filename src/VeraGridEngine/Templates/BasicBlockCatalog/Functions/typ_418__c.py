...
def build_typ_418__c_default_template_name() -> str:
    """
...
def build_typ_418__c_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_418__c_default_template_name()
    else:
        template_name = name
