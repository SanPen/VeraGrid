...
"""
Standalone EMT template for the basic catalog block 'C'.
...
def build_typ_430__c_default_template_name() -> str:
    """
...
def build_typ_430__c_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_430__c_default_template_name()
    else:
        template_name = name
    ...
    C_C: Var = vf.add_var('C__C_' + template_name)
    ...
    algebraic_equations.append((yo - C_C))
    ...
    event_parameters[C_C] = vf.add_const(None, name='C')
