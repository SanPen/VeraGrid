...
def build_typ_439__kc_1_sti_p_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Kc+1/sTi [(p__439'

def build_typ_439__kc_1_sti_p_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_439__kc_1_sti_p_default_template_name()
    else:
        template_name = name
    ...
    Kc_1_sTi_p_T_rise: Var = vf.add_var('Kc+1/sTi [(p__T_rise_' + template_name)
    ...
    Kc_1_sTi_p_T_p: Var = vf.add_var('Kc+1/sTi [(p_T_p_' + template_name)
    ...
    event_parameters[Kc_1_sTi_p_T_rise] = vf.add_const(None, name='T_rise')
    ...
    initial_equations[Kc_1_sTi_p_T_p] = (Kc_1_sTi_p_T_rise / sym.Const(2.197))
