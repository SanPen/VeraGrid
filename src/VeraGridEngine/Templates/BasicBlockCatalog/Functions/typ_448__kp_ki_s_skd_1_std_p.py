...
def build_typ_448__kp_ki_s_skd_1_std_p_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Kp+Ki/s+sKd/(1+sTd) [(p__448'

def build_typ_448__kp_ki_s_skd_1_std_p_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_448__kp_ki_s_skd_1_std_p_default_template_name()
    else:
        template_name = name
    ...
    state_equations.append((yi * Kp_Ki_s_sKd_1_sTd_p_Ki))
    state_equations.append(Kp_Ki_s_sKd_1_sTd_p_dx2)
