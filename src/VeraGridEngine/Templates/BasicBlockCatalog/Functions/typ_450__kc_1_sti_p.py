...
def build_typ_450__kc_1_sti_p_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Kc+1/sTi [(p__450'

def build_typ_450__kc_1_sti_p_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_450__kc_1_sti_p_default_template_name()
    else:
        template_name = name
