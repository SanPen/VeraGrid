...
def build_typ_451__kc_1_sti_p_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Kc+1/sTi [(p__451'

def build_typ_451__kc_1_sti_p_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_451__kc_1_sti_p_default_template_name()
    else:
        template_name = name
    ...
    Kc_1_sTi_p_x_init: Var = vf.add_var('Kc+1/sTi [(p_x_init_' + template_name)
    ...
    initial_equations[Kc_1_sTi_p_x_init] = Kc_1_sTi_p_x
    ...
    procedural_logic_entries.append(reset(Kc_1_sTi_p_x, rst, Kc_1_sTi_p_x_init))
