...
def build_typ_462__kp_ki_s_skd_1_std_p_default_template_name() -> str:
    """
    Return the canonical runtime name for this standalone template.

    :returns: Default template name.
    """
    return 'Kp+Ki/s+sKd/(1+sTd) [(p__462'

def build_typ_462__kp_ki_s_skd_1_std_p_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_462__kp_ki_s_skd_1_std_p_default_template_name()
    else:
        template_name = name
    ...
    Kp_Ki_s_sKd_1_sTd_p_x1_init: Var = vf.add_var('Kp+Ki/s+sKd/(1+sTd) [(p_x1_init_' + template_name)
    ...
    initial_equations[Kp_Ki_s_sKd_1_sTd_p_x1_init] = Kp_Ki_s_sKd_1_sTd_p_x1
    ...
    procedural_logic_entries.append(reset(Kp_Ki_s_sKd_1_sTd_p_x1, rst, Kp_Ki_s_sKd_1_sTd_p_x1_init))
