...
"""
Standalone EMT template for the basic catalog block '0'.
...
def build_typ_50__0_default_template_name() -> str:
    """
...
def build_typ_50__0_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_50__0_default_template_name()
    else:
        template_name = name
