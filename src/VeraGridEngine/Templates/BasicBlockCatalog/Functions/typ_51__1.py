...
"""
Standalone EMT template for the basic catalog block '1'.
...
def build_typ_51__1_default_template_name() -> str:
    """
...
def build_typ_51__1_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_51__1_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - sym.Const(1.0)))
