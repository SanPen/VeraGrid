...
"""
Standalone EMT template for the basic catalog block 'Bias'.
...
def build_typ_54__bias_default_template_name() -> str:
    """
...
def build_typ_54__bias_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_54__bias_default_template_name()
    else:
        template_name = name
    ...
    Bias_bias: Var = vf.add_var('Bias_bias_' + template_name)
    ...
    algebraic_equations.append((yo - Bias_bias))
    ...
    initial_equations[Bias_bias] = yo
