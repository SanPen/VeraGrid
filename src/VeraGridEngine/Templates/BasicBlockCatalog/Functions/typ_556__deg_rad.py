...
"""
Standalone EMT template for the basic catalog block 'deg -> rad'.
...
def build_typ_556__deg_rad_default_template_name() -> str:
    """
...
def build_typ_556__deg_rad_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_556__deg_rad_default_template_name()
    else:
        template_name = name
