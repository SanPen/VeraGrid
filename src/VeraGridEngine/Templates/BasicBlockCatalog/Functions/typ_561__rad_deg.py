...
"""
Standalone EMT template for the basic catalog block 'rad -> deg'.
...
def build_typ_561__rad_deg_default_template_name() -> str:
    """
...
def build_typ_561__rad_deg_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_561__rad_deg_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - ((yi * sym.Const(180.0)) / sym.Const(3.141592653589793))))
