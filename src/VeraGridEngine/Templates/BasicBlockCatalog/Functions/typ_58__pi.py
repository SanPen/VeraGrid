...
"""
Standalone EMT template for the basic catalog block 'PI'.
...
def build_typ_58__pi_default_template_name() -> str:
    """
...
def build_typ_58__pi_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_58__pi_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - sym.Const(3.141592653589793)))
