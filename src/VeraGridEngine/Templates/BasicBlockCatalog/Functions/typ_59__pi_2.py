...
"""
Standalone EMT template for the basic catalog block 'PI/2'.
...
def build_typ_59__pi_2_default_template_name() -> str:
    """
...
def build_typ_59__pi_2_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_59__pi_2_default_template_name()
    else:
        template_name = name
    ...
    algebraic_equations.append((yo - (sym.Const(3.141592653589793) / sym.Const(2.0))))
