...
"""
Standalone EMT template for the basic catalog block 'lapprox'.
...
def build_typ_71__lapprox_default_template_name() -> str:
    """
...
def build_typ_71__lapprox_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_71__lapprox_default_template_name()
    else:
        template_name = name
    ...
    lapprox_array_K: Var = vf.add_var('lapprox__array_K_' + template_name)
    ...
    event_parameters[lapprox_array_K] = vf.add_const(None, name='array_K')
