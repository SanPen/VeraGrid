...
"""
Standalone EMT template for the basic catalog block 'lim'.
...
def build_typ_75__lim_default_template_name() -> str:
    """
...
def build_typ_75__lim_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_75__lim_default_template_name()
    else:
        template_name = name
