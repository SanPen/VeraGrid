...
"""
Standalone EMT template for the basic catalog block 'sapprox'.
...
def build_typ_81__sapprox_default_template_name() -> str:
    """
...
def build_typ_81__sapprox_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    """
    ...
    template_name: str
    if name is None:
        template_name = build_typ_81__sapprox_default_template_name()
    else:
        template_name = name
    ...
    sapprox_array_K: Var = vf.add_var('sapprox__array_K_' + template_name)
    ...
    event_parameters[sapprox_array_K] = vf.add_const(None, name='array_K')
