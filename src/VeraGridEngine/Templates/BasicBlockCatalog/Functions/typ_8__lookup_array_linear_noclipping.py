...
def build_typ_8__lookup_array_linear_noclipping_template(vf: VarFactory, name: str | None = None) -> EmtModelTemplate:
    ...
    Lookup_array_linear_noclipping_array_K: Var = vf.add_var('Lookup array (linear_noclipping)__array_K_' + template_name)
    ...
    event_parameters[Lookup_array_linear_noclipping_array_K] = vf.add_const(None, name='array_K')
