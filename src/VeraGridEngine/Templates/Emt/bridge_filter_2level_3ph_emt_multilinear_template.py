...
def get_bridge_filter_2level_3ph_emt_multilinear_template(vf: VarFactory,
    ...
    u_cos_pll: Var | None = find_name_in_block(f"u_cos_pll_{name}_bridge", bridge_block)
    u_sin_pll: Var | None = find_name_in_block(f"u_sin_pll_{name}_bridge", bridge_block)
