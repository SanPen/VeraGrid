...
from VeraGridEngine.Templates.Emt.bridge_2level_3ph_emt_soft_pwm_compatible_template import get_bridge_2level_3ph_emt_soft_pwm_compatible_template
...
def get_bridge_filter_2level_3ph_soft_emt_template(vf: VarFactory,
                                                   name: str = "bridge_filter_2level_3ph_soft_emt") -> EmtModelTemplate:
    """
    Build a standalone soft-sign 2-level bridge with a three-phase RL AC filter.
    ...
    carrier_enable: Var = vf.add_var(name=f"carrier_enable_in")
    ...
    # Bridge child block.
    # ------------------------------------------------------------------
    bridge_block: Block = get_bridge_2level_3ph_emt_soft_pwm_compatible_template(vf=vf, name=f"{name}_bridge").block
