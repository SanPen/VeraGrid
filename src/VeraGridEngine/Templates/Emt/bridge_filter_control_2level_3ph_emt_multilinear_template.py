...
def _build_bridge_filter_current_control_block(vf: VarFactory, name: str) -> Block:
    ...
    v_d_cap_out: Var = vf.add_var(name=f"v_d_cap")
    v_d_cap_mode: Var = vf.add_var(name=f"v_d_cap_mode")
    v_q_cap: Var = vf.add_var(name=f"v_q_cap")
    v_q_cap_aux: Var = vf.add_var(name=f"v_q_cap_aux")
    v_0_cap: Var = vf.add_var(name=f"v_0_cap")
    v_0_cap_aux: Var = vf.add_var(name=f"v_0_cap_aux")
    v_lim_aux: Var = vf.add_var(name=f"v_lim_aux")
    v_cmd_d_aux: Var = vf.add_var(name=f"v_cmd_d_aux")
    v_cmd_q_aux: Var = vf.add_var(name=f"v_cmd_q_aux")
    v_cmd_norm: Var = vf.add_var(name=f"v_cmd_norm")
    v_cmd_norm_aux: Var = vf.add_var(name=f"v_cmd_norm_aux")
    v_cmd_d0_aux: Var = vf.add_var(name=f"v_cmd_d0_aux")
    v_cmd_q0_aux: Var = vf.add_var(name=f"v_cmd_q0_aux")
