...
def get_switched_emt_converter(vf: VarFactory, name: str = "switched_converter_emt") -> EmtModelTemplate:
    ...
    plant_i_A: Var | None = plant_lookup.get("i_A", None)
    plant_i_B: Var | None = plant_lookup.get("i_B", None)
    plant_i_C: Var | None = plant_lookup.get("i_C", None)
    plant_i_d: Var | None = plant_lookup.get("i_d", None)
    plant_i_q: Var | None = plant_lookup.get("i_q", None)
    plant_i_0: Var | None = plant_lookup.get("i_0", None)
    plant_v_d: Var | None = plant_lookup.get("v_d", None)
    plant_v_q: Var | None = plant_lookup.get("v_q", None)
    plant_v_0: Var | None = plant_lookup.get("v_0", None)
    ...
    plant_v_conv_a: Var | None = plant_lookup.get("v_conv_a", None)
    plant_v_conv_b: Var | None = plant_lookup.get("v_conv_b", None)
    plant_v_conv_c: Var | None = plant_lookup.get("v_conv_c", None)
    plant_v_conv_d: Var | None = plant_lookup.get("v_conv_d", None)
    plant_v_conv_q: Var | None = plant_lookup.get("v_conv_q", None)
    plant_v_conv_0: Var | None = plant_lookup.get("v_conv_0", None)
