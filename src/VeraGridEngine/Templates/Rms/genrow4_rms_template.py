...
def get_genrow4_rms_template(var_factory: VarFactory, name = "Genrow rms template") -> RmsModelTemplate:
    """
    ...
    templ.block.event_dict[M] = var_factory.add_const(12.35 * 9.0)
    ...
    templ.block.event_dict[vf] = var_factory.add_const(None)
    templ.block.event_dict[tm0] = var_factory.add_const(None)
