...
"""
Maintainable international-standard module for 'Ac1a'.
...
recovered BasicBlockCatalog structures for incremental maintenance.
"""
...
def build_ac1a_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    algebraic_equations.append((avr_limiter_y - ((sym.heaviside(((avr_min1_yMin - avr_limiter_uMax) - sym.Const(1e-06))) * avr_limiter_uMax) + ((sym.Const(1.0) - sym.heaviside(((avr_min1_yMin - avr_limiter_uMax) - sym.Const(1e-06)))) * ((sym.heaviside(((avr_limiter_uMin - avr_min1_yMin) - sym.Const(1e-06))) * avr_limiter_uMin) + ((sym.Const(1.0) - sym.heaviside(((avr_limiter_uMin - avr_min1_yMin) - sym.Const(1e-06)))) * avr_min1_yMin))))))
    ...
    algebraic_equations.append((avr_add3_y - ((((avr_UsRefPu - avr_firstOrder_y) + avr_UPssPu) + avr_UOelPu) + avr_UUelPu)))
    algebraic_equations.append((avr_feedback_y - (avr_add3_y - avr_derivative_y)))
    ...
    algebraic_equations.append((avr_limitedFirstOrder_feedback_y - (avr_limitedFirstOrder_Gk_y - avr_max1_u_1)))
    ...
    initial_equations[avr_max1_u_1] = avr_limitedFirstOrder_Y0
    ...
    initial_equations[avr_add3_y] = ((((avr_UsRefPu - avr_firstOrder_y) + avr_UPssPu) + avr_UOelPu) + avr_UUelPu)
    ...
    template.comment = 'Generator AVR/exciter IEEE AC1A'
    return template
