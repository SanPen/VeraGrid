...
"""
Maintainable international-standard module for 'Dc1a'.
...
def build_dc1a_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    algebraic_equations.append((avr_product_y - (avr_add_y * avr_integrator_y)))
    ...
    algebraic_equations.append((avr_max1_u_2 - (((avr_transferFunction_bb_2 - (avr_transferFunction_d * avr_transferFunction_a_2)) * avr_transferFunction_x_1) + (avr_transferFunction_d * avr_feedback_y))))
    algebraic_equations.append((avr_limitedFirstOrder_Gk_y - (avr_limitedFirstOrder_Gk_k * avr_max1_u_2)))
    ...
    algebraic_equations.append((avr_power_y - sym.exp((avr_BEx * avr_integrator_y))))
    ...
    initial_equations[avr_max1_u_2] = avr_transferFunction_y_start
    initial_equations[avr_product_y] = (avr_add_y * avr_integrator_y)
    ...
    initial_equations[avr_power_y] = sym.exp((avr_BEx * avr_integrator_y))
    ...
    template.comment = 'Generator AVR/exciter IEEE DC1A'
    return template
