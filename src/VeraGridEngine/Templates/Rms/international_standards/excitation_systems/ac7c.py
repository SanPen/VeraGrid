...
"""
Maintainable international-standard module for 'Ac7c'.
...
def build_ac7c_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    avr_Kc1: Var = vf.add_var('avr.Kc1_' + template_name)
    ...
    avr_Sw2: Var = vf.add_var('avr.Sw2_' + template_name)
    ...
    avr_booleanConstant1_k: Var = vf.add_var('avr.booleanConstant1.k_' + template_name)
    ...
    avr_constant1_k: Var = vf.add_var('avr.constant1.k_' + template_name)
    ...
    avr_add2_u2: Var = vf.add_var('avr.add2.u2_' + template_name)
    ...
    avr_min3_u1: Var = vf.add_var('avr.min3.u1_' + template_name)
    ...
    algebraic_equations.append((avr_switch_y - ((avr_booleanConstant_k * avr_potentialCircuit_vE) + ((sym.Const(1.0) - avr_booleanConstant_k) * avr_constant1_k))))
    ...
    algebraic_equations.append((avr_gain2_y - (avr_gain2_k * avr_EfdPu)))
    ...
    algebraic_equations.append((avr_gain1_y - (avr_gain1_k * avr_acRotatingExciter_VfePu)))
    algebraic_equations.append((avr_division_y - (avr_gain1_y / avr_switch_y)))
    ...
    algebraic_equations.append((avr_min4_y - ((avr_const2_k * sym.heaviside((avr_product1_y - avr_const2_k))) + (avr_product1_y * (sym.Const(1) - sym.heaviside((avr_product1_y - avr_const2_k)))))))
    algebraic_equations.append((avr_switch1_y - ((avr_booleanConstant1_k * avr_min4_y) + ((sym.Const(1.0) - avr_booleanConstant1_k) * avr_gain2_y))))
    algebraic_equations.append((avr_sum1_u_1 - (avr_UsRefPu - avr_firstOrder_y)))
    algebraic_equations.append((avr_sum1_y - (((((avr_sum1_k_1 * avr_sum1_u_1) + (avr_sum1_k_2 * avr_sum1_u_2)) + (avr_sum1_k_3 * avr_sum1_u_3)) + (avr_sum1_k_4 * avr_sum1_u_4)) + (avr_sum1_k_5 * avr_sum1_u_5))))
    algebraic_equations.append((avr_max1_u_2 - (avr_sum1_y - avr_derivative_y)))
    algebraic_equations.append((avr_min1_u_2 - (avr_add2_k1 * avr_max1_u_2)))
    algebraic_equations.append((avr_pid_addP_y - ((avr_pid_addP_k1 * avr_min1_u_2) + (avr_pid_addP_k2 * avr_const1_k))))
    algebraic_equations.append((avr_pid_P_y - (avr_pid_P_k * avr_pid_addP_y)))
    algebraic_equations.append((avr_pid_addD_y - ((avr_pid_addD_k1 * avr_min1_u_2) + (avr_pid_addD_k2 * avr_const1_k))))
    ...
    algebraic_equations.append((avr_min3_u1 - ((sym.heaviside(((avr_limitedPI_add_y - avr_limitedPI_limiter1_uMax) - sym.Const(1e-06))) * avr_limitedPI_limiter1_uMax) + ((sym.Const(1.0) - sym.heaviside(((avr_limitedPI_add_y - avr_limitedPI_limiter1_uMax) - sym.Const(1e-06)))) * ((sym.heaviside(((avr_limitedPI_limiter1_uMin - avr_limitedPI_add_y) - sym.Const(1e-06))) * avr_limitedPI_limiter1_uMin) + ((sym.Const(1.0) - sym.heaviside(((avr_limitedPI_limiter1_uMin - avr_limitedPI_add_y) - sym.Const(1e-06)))) * avr_limitedPI_add_y))))))
    algebraic_equations.append((avr_min3_y - ((avr_min3_u1 * sym.heaviside((avr_min3_u1 - avr_min3_u1))) + (avr_min3_u1 * (sym.Const(1) - sym.heaviside((avr_min3_u1 - avr_min3_u1)))))))
    algebraic_equations.append((avr_product_y - (avr_switch1_y * avr_min3_y)))
    ...
    algebraic_equations.append((avr_pid_addSat_y - ((avr_pid_addSat_k1 * avr_min2_u_2) + (avr_pid_addSat_k2 * avr_pid_limiter_u))))
    algebraic_equations.append((avr_pid_gainTrack_y - (avr_pid_gainTrack_k * avr_pid_addSat_y)))
    algebraic_equations.append((avr_pid_addI_y - ((avr_pid_addI_k1 * avr_min1_u_2) + ((avr_pid_addI_k2 * avr_const1_k) + (avr_pid_addI_k3 * avr_pid_gainTrack_y)))))
    algebraic_equations.append((avr_pid_controlError - (avr_min1_u_2 - avr_const1_k)))
    algebraic_equations.append((avr_sum1_u_2 - avr_UOelPu))
    algebraic_equations.append((avr_sum1_u_3 - avr_UPssPu))
    algebraic_equations.append((avr_sum1_u_4 - avr_USclOelPu))
    algebraic_equations.append((avr_sum1_u_5 - (avr_USclUelPu + avr_UUelPu)))
    ...
    algebraic_variables.append(avr_min3_u1)
    ...
    algebraic_variables.append(avr_add2_u2)
    ...
    event_parameters[avr_Kc1] = vf.add_const(0.0, name='')
    ...
    event_parameters[avr_Kr] = vf.add_const(0.0, name='')
    ...
    event_parameters[avr_add2_k1] = vf.add_const(1.0, name='')
    ...
    event_parameters[avr_constant1_k] = avr_Kp
    ...
    event_parameters[avr_gain1_k] = avr_Kc1
    event_parameters[avr_gain2_k] = avr_Kr
    ...
    event_parameters[avr_Sw2] = vf.add_const(0.0, name='')
    ...
    event_parameters[avr_booleanConstant1_k] = avr_Sw2
    ...
    initial_equations[avr_gain2_y] = vf.add_const(0.0, name='')
    initial_equations[avr_itPu_im] = vf.add_const(0.0, name='')
    initial_equations[avr_itPu_re] = vf.add_const(0.8, name='')
    initial_equations[avr_min3_u1] = avr_limitedPI_Y0
    initial_equations[avr_rectifierRegulationCharacteristic_y] = vf.add_const(1.0, name='')
    initial_equations[avr_switch_y] = vf.add_const(1.0, name='')
    initial_equations[avr_switch1_y] = vf.add_const(0.0, name='')
    ...
    initial_equations[avr_min2_u_2] = ((sym.heaviside(((avr_pid_limiter_u - avr_pid_limiter_uMax) - sym.Const(1e-06))) * avr_pid_limiter_uMax) + ((sym.Const(1.0) - sym.heaviside(((avr_pid_limiter_u - avr_pid_limiter_uMax) - sym.Const(1e-06)))) * ((sym.heaviside(((avr_pid_limiter_uMin - avr_pid_limiter_u) - sym.Const(1e-06))) * avr_pid_limiter_uMin) + ((sym.Const(1.0) - sym.heaviside(((avr_pid_limiter_uMin - avr_pid_limiter_u) - sym.Const(1e-06)))) * avr_pid_limiter_u))))
    ...
    initial_equations[avr_add2_u2] = vf.add_const(0.0, name='')
    initial_equations[avr_sum1_u_3] = avr_UPssPu
    initial_equations[avr_sum1_u_4] = avr_USclOelPu
    initial_equations[avr_sum1_u_5] = (avr_USclUelPu + avr_UUelPu)
    initial_equations[avr_sum1_u_1] = (avr_UsRefPu - avr_firstOrder_y)
    initial_equations[avr_sum1_y] = (((((avr_sum1_k_1 * avr_sum1_u_1) + (avr_sum1_k_2 * avr_sum1_u_2)) + (avr_sum1_k_3 * avr_sum1_u_3)) + (avr_sum1_k_4 * avr_sum1_u_4)) + (avr_sum1_k_5 * avr_sum1_u_5))
    ...
    template.comment = 'Generator AVR/exciter IEEE AC7C'
    return template
