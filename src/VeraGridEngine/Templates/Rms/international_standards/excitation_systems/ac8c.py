...
"""
Maintainable international-standard module for 'Ac8c'.
...
def build_ac8c_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    algebraic_equations.append((avr_min3_y - ((avr_const2_k * sym.heaviside((avr_product1_y - avr_const2_k))) + (avr_product1_y * (sym.Const(1) - sym.heaviside((avr_product1_y - avr_const2_k)))))))
    algebraic_equations.append((avr_sum1_u_1 - (avr_UsRefPu - avr_firstOrder_y)))
    algebraic_equations.append((avr_max1_u_3 - ((((avr_sum1_k_1 * avr_sum1_u_1) + (avr_sum1_k_2 * avr_sum1_u_2)) + (avr_sum1_k_3 * avr_sum1_u_3)) + (avr_sum1_k_4 * avr_sum1_u_4))))
    algebraic_equations.append((avr_min1_u_3 - (avr_add2_k1 * avr_max1_u_3)))
    algebraic_equations.append((avr_pid_addP_y - ((avr_pid_addP_k1 * avr_min1_u_3) + (avr_pid_addP_k2 * avr_const1_k))))
    algebraic_equations.append((avr_pid_P_y - (avr_pid_P_k * avr_pid_addP_y)))
    algebraic_equations.append((avr_pid_addD_y - ((avr_pid_addD_k1 * avr_min1_u_3) + (avr_pid_addD_k2 * avr_const1_k))))
    ...
    algebraic_equations.append((avr_product_y - (avr_min3_y * avr_limitedFirstOrder_y)))
    algebraic_equations.append((avr_acRotatingExciter_feedback_y - (avr_product_y - avr_acRotatingExciter_VfePu)))
    ...
    initial_equations[avr_acRotatingExciter_firstOrder_y] = START_avr_acRotatingExciter_firstOrder_y
    initial_equations[avr_acRotatingExciter_integratorVariableLimits_derivativeLimitMax_x] = START_avr_acRotatingExciter_integratorVariableLimits_derivativeLimitMax_x
    initial_equations[avr_acRotatingExciter_integratorVariableLimits_derivativeLimitMin_x] = START_avr_acRotatingExciter_integratorVariableLimits_derivativeLimitMin_x
    initial_equations[avr_acRotatingExciter_integratorVariableLimits_w] = START_avr_acRotatingExciter_integratorVariableLimits_w
    ...
    initial_equations[avr_pid_D_x] = START_avr_pid_D_x
    ...
    initial_equations[avr_product_y] = avr_acRotatingExciter_Efe0Pu
    ...
    initial_equations[avr_max1_u_3] = ((((avr_sum1_k_1 * avr_sum1_u_1) + (avr_sum1_k_2 * avr_sum1_u_2)) + (avr_sum1_k_3 * avr_sum1_u_3)) + (avr_sum1_k_4 * avr_sum1_u_4))
    ...
    template.comment = 'Generator AVR/exciter IEEE AC8C'
    return template
