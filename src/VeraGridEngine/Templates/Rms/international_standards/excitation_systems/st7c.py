...
"""
Maintainable international-standard module for 'St7c'.
...
def build_st7c_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    state_equations.append((((avr_firstOrder1_k * avr_min2_u_3) - avr_firstOrder1_y) / avr_firstOrder1_T))
    ...
    output_variables.append(avr_VFbPu)
    ...
    template.comment = 'Generator AVR/exciter IEEE ST7C'
    return template
