...
def build_govsteameu_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    ...
    # Preserve the public connector surface declared by the source GovSteamEu model.
    input_variables.append(gov_fPu)
    input_variables.append(gov_fRefPu)
    input_variables.append(gov_omegaPu)
    input_variables.append(gov_omegaRefPu)
    input_variables.append(gov_PGenPu)
    input_variables.append(gov_PRefPu)
