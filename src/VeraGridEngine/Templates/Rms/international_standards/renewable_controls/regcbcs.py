...
def build_regcbcs_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    ...
    input_variables.append(ctrl_UPu)
    input_variables.append(ctrl_frtOn)
    input_variables.append(ctrl_idCmdPu)
    input_variables.append(ctrl_iqCmdPu)
    output_variables: list[Var] = list()
    output_variables.append(ctrl_idRefPu)
    output_variables.append(ctrl_iqRefPu)
