...
"""
Maintainable international-standard module for 'St5b'.
...
def build_st5b_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    avr_limitedLeadLag_y: Var = vf.add_var('avr.limitedLeadLag.y_' + template_name)
    ...
    avr_min1_u_1: Var = vf.add_var('avr.min1.u[1]_' + template_name)
    avr_min1_yMax: Var = vf.add_var('avr.min1.yMax_' + template_name)
    avr_min1_yMin: Var = vf.add_var('avr.min1.yMin_' + template_name)
    ...
    state_equations.append((((avr_limitedLeadLag_firstOrder_k * avr_limitedLeadLag_y) - avr_limitedLeadLag_firstOrder_y) / avr_limitedLeadLag_firstOrder_T))
    ...
    algebraic_equations.append((avr_max1_u_1 - ((((avr_UsRefPu - avr_firstOrder_y) + avr_UOelPu) + avr_UPssPu) + avr_UUelPu)))
    ...
    algebraic_equations.append((avr_min1_u_1 - ((avr_max1_u_1 * sym.heaviside((avr_max1_u_1 - sym.Const(0.0)))) + (sym.Const(0.0) * (sym.Const(1) - sym.heaviside((avr_max1_u_1 - sym.Const(0.0))))))))
    algebraic_equations.append((avr_min1_yMin - ((avr_min1_u_1 * sym.heaviside((sym.Const(0.0) - avr_min1_u_1))) + (sym.Const(0.0) * (sym.Const(1) - sym.heaviside((sym.Const(0.0) - avr_min1_u_1)))))))
    algebraic_equations.append((avr_min1_yMax - ((avr_min1_u_1 * sym.heaviside((avr_min1_u_1 - sym.Const(0.0)))) + (sym.Const(0.0) * (sym.Const(1) - sym.heaviside((avr_min1_u_1 - sym.Const(0.0))))))))
    algebraic_equations.append((avr_add1_y - ((avr_add1_k1 * avr_UPssPu) + (avr_add1_k2 * avr_min1_yMin))))
    ...
    algebraic_equations.append((avr_limitedLeadLag_y - ((sym.heaviside(((avr_limitedLeadLag_gain_y - avr_limitedLeadLag_limiter_uMax) - sym.Const(1e-06))) * avr_limitedLeadLag_limiter_uMax) + ((sym.Const(1.0) - sym.heaviside(((avr_limitedLeadLag_gain_y - avr_limitedLeadLag_limiter_uMax) - sym.Const(1e-06)))) * ((sym.heaviside(((avr_limitedLeadLag_limiter_uMin - avr_limitedLeadLag_gain_y) - sym.Const(1e-06))) * avr_limitedLeadLag_limiter_uMin) + ((sym.Const(1.0) - sym.heaviside(((avr_limitedLeadLag_limiter_uMin - avr_limitedLeadLag_gain_y) - sym.Const(1e-06)))) * avr_limitedLeadLag_gain_y))))))
    algebraic_equations.append((avr_limiter_u - ((sym.heaviside(((avr_min1_u_1 - avr_min1_yMin) - sym.Const(1e-06))) * avr_limitedLeadLag2_y) + ((sym.Const(1.0) - sym.heaviside(((avr_min1_u_1 - avr_min1_yMin) - sym.Const(1e-06)))) * ((sym.heaviside(((avr_min1_u_1 - avr_max1_u_1) - sym.Const(1e-06))) * avr_limitedLeadLag1_y) + ((sym.Const(1.0) - sym.heaviside(((avr_min1_u_1 - avr_max1_u_1) - sym.Const(1e-06)))) * avr_limitedLeadLag_y))))))
    ...
    algebraic_variables.append(avr_min1_u_1)
    algebraic_variables.append(avr_min1_yMin)
    algebraic_variables.append(avr_min1_yMax)
    ...
    algebraic_variables.append(avr_limitedLeadLag_y)
    ...
    initial_equations[avr_limitedLeadLag_y] = avr_limitedLeadLag_Y0
    ...
    initial_equations[avr_max1_u_1] = ((((avr_UsRefPu - avr_firstOrder_y) + avr_UOelPu) + avr_UPssPu) + avr_UUelPu)
    initial_equations[avr_add1_y] = ((avr_add1_k1 * avr_UPssPu) + (avr_add1_k2 * avr_min1_yMin))
    ...
    template.comment = 'Generator AVR/exciter IEEE ST5B'
    return template
