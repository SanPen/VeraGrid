...
"""
Maintainable international-standard module for 'St6b'.
...
def build_st6b_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    """
    ...
    avr_max1_u_1: Var = vf.add_var('avr.max1.u[1]_' + template_name)
    avr_max1_yMin: Var = vf.add_var('avr.max1.yMin_' + template_name)
    ...
    algebraic_equations.append((avr_division_y - (avr_gain1_k / avr_potentialCircuit_vE)))
    ...
    algebraic_equations.append((avr_product1_y - (avr_rectifierRegulationCharacteristic_y * avr_potentialCircuit_vE)))
    ...
    algebraic_equations.append((avr_sum1_u_1 - (((avr_UsRefPu - avr_firstOrder_y) + avr_UOelPu) + avr_UPssPu)))
    algebraic_equations.append((avr_max1_u_1 - ((avr_sum1_k_1 * avr_sum1_u_1) + (avr_sum1_k_2 * avr_sum1_u_2))))
    algebraic_equations.append((avr_max1_yMin - ((avr_max1_u_1 * sym.heaviside((sym.Const(0.0) - avr_max1_u_1))) + (sym.Const(0.0) * (sym.Const(1) - sym.heaviside((sym.Const(0.0) - avr_max1_u_1)))))))
    algebraic_equations.append((avr_min1_u_2 - ((avr_max1_u_1 * sym.heaviside((avr_max1_u_1 - sym.Const(0.0)))) + (sym.Const(0.0) * (sym.Const(1) - sym.heaviside((avr_max1_u_1 - sym.Const(0.0))))))))
    ...
    algebraic_equations.append((avr_limPI1_y - ((sym.heaviside(((avr_limPI1_add_y - avr_const3_k) - sym.Const(1e-06))) * avr_const3_k) + ((sym.Const(1.0) - sym.heaviside(((avr_limPI1_add_y - avr_const3_k) - sym.Const(1e-06)))) * ((sym.heaviside(((avr_const4_k - avr_limPI1_add_y) - sym.Const(1e-06))) * avr_const4_k) + ((sym.Const(1.0) - sym.heaviside(((avr_const4_k - avr_limPI1_add_y) - sym.Const(1e-06)))) * avr_limPI1_add_y))))))
    ...
    algebraic_equations.append((avr_EfdPu - (avr_min5_y * avr_min4_y)))
    ...
    algebraic_equations.append((avr_sum1_u_2 - avr_UUelPu))
    ...
    algebraic_variables.append(avr_max1_u_1)
    algebraic_variables.append(avr_max1_yMin)
    ...
    event_parameters[avr_sum2_nin] = vf.add_const(3.0, name='')
    ...
    initial_equations[avr_sum1_u_2] = avr_UUelPu
    initial_equations[avr_sum2_u_3] = vf.add_const(0.0, name='')
    initial_equations[avr_sum1_u_1] = (((avr_UsRefPu - avr_firstOrder_y) + avr_UOelPu) + avr_UPssPu)
    initial_equations[avr_max1_u_1] = ((avr_sum1_k_1 * avr_sum1_u_1) + (avr_sum1_k_2 * avr_sum1_u_2))
    ...
    template.comment = 'Generator AVR/exciter IEEE ST6B'
    return template
