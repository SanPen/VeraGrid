...
def build_wt4injector_template(vf: VarFactory, name: str | None = None) -> RmsModelTemplate:
    ...
    input_variables.append(inj_fOCB)
    input_variables.append(inj_ipCmdPu)
    input_variables.append(inj_ipMaxPu)
    input_variables.append(inj_iqCmdPu)
    input_variables.append(inj_iqMaxPu)
    input_variables.append(inj_iqMinPu)
    input_variables.append(inj_theta)
    output_variables: list[Var] = list()
    output_variables.append(inj_PAgPu)
    output_variables.append(inj_iWtPu_im)
    output_variables.append(inj_iWtPu_re)
