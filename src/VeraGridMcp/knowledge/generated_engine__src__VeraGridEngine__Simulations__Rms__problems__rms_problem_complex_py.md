# VeraGridEngine Module: src/VeraGridEngine/Simulations/Rms/problems/rms_problem_complex.py

- Original source path: `src/VeraGridEngine/Simulations/Rms/problems/rms_problem_complex.py`
...
## Class: RmsProblemComplex

- Bases: RmsProblemTemplate
- Summary: Complex Phasor-based DAE (Differential-Algebraic Equation) class with MULTILINEAR equations.

### Methods

- `add_variables_to_compilation_dicts(self, elm, mdl)`
  Summary: Add variables and parameters to the compilation dictionaries.
- `_rebuild_compilation_dicts(self)`
  Summary: Rebuild compilation dictionaries after all models are added.
- `_compile_system(self)`
  Summary: Compile RHS and Jacobian using JIT Compiler.
