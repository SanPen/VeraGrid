# VeraGridEngine Module: src/VeraGridEngine/Templates/Rms/load2_rms_template.py

- Original source path: `src/VeraGridEngine/Templates/Rms/load2_rms_template.py`
...
## Function: get_load2_rms_template(var_factory, name)
