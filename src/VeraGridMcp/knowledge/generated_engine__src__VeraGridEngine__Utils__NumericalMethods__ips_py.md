# VeraGridEngine Module: src/VeraGridEngine/Utils/NumericalMethods/ips.py

- Original source path: `src/VeraGridEngine/Utils/NumericalMethods/ips.py`
...
## Function: calc_feascond(g, h, x, z)

Calculate the feasible conditions

## Function: calc_gradcond(lx, lam, mu)

calculate the gradient conditions

## Function: calc_ccond(mu, z, x)

:param mu: Vector of mu mutipliers

## Function: calc_ocond(f, f_prev)
...
## Function: interior_point_solver(x0, n_x, n_eq, n_ineq, func, arg, max_iter, tol, pf_init, trust, verbose, step_control)
