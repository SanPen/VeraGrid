...
def build_named_variable_list(genqec_mdl: Block,
    ...
    named_vars.append(("delta", find_name_in_block("delta", genqec_mdl)))
    named_vars.append(("omega", find_name_in_block("omega", genqec_mdl)))
    named_vars.append(("Eq_prime", find_name_in_block("Eq_prime", genqec_mdl)))
    named_vars.append(("Ed_prime", find_name_in_block("Ed_prime", genqec_mdl)))
    named_vars.append(("Psiq_prime", find_name_in_block("Psiq_prime", genqec_mdl)))
    named_vars.append(("Psid_prime", find_name_in_block("Psid_prime", genqec_mdl)))
    ...
    named_vars.append(("Psid", find_name_in_block("Psid", genqec_mdl)))
    named_vars.append(("Psiq", find_name_in_block("Psiq", genqec_mdl)))
    named_vars.append(("Te", find_name_in_block("Te", genqec_mdl)))
    named_vars.append(("Ed1", find_name_in_block("Ed1", genqec_mdl)))
    named_vars.append(("Eq1", find_name_in_block("Eq1", genqec_mdl)))
    named_vars.append(("IRPu", find_name_in_block("IRPu", genqec_mdl)))
